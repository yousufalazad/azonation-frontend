  ...
  <header class="fixed border-b top-0 left-0 w-full bg-white z-50">
    <div class="container mx-auto flex justify-between items-center px-2 py-5">
      ...
      <div class="flex items-center space-x-4 relative">
        ...
        <router-link to="/login" class="px-3 py-2 text-black rounded-full hover:bg-black hover:text-white transition">
          Individual
        </router-link>
        ...
        <!-- Developer Menu with Dropdown -->
        <div class="relative group">
          <button
            class="px-3 py-2 text-black rounded-full hover:bg-black hover:text-white transition flex items-center space-x-1 focus:outline-none">
            <span>Developer</span>
          ...
          <!-- Mega Menu -->
          <div
            class="absolute left-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg p-4 hidden group-hover:block z-50">
            <router-link to="/developer/docs" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded">
              Documentation
            </router-link>
            <router-link to="/developer/api" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded">
              API Reference
            </router-link>
            <router-link to="/developer/sdk" class="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded">
              SDKs & Tools
            </router-link>
            <router-link to="/developer/support"
