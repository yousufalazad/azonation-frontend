...
const fetchProductDetails = async () => {
  try {
    ...
    if (response.status) {
      ...
      business_type_id.value = data.business_type_id;
      category_id.value = data.category_id;
      sub_category_id.value = data.sub_category_id;
      sub_sub_category_id.value = data.sub_sub_category_id;
      brand_id.value = data.brand_id;
      sku.value = data.sku;
      name.value = data.name;
      slug.value = data.slug;
      short_description.value = data.short_description;
      invoice_description.value = data.invoice_description;
      description.value = data.description;
      base_price.value = data.base_price;
      on_sale.value = data.on_sale;
      discount_percentage.value = data.discount_percentage;
      sale_price.value = data.sale_price;
      sale_start_date.value = data.sale_start_date;
      sale_end_date.value = data.sale_end_date;
      is_downloadable.value = data.is_downloadable;
      download_link.value = data.download_link;
      is_gift_card.value = data.is_gift_card;
      is_refundable.value = data.is_refundable;
      is_customizable.value = data.is_customizable;
      is_backorderable.value = data.is_backorderable;
      is_sold_individually.value = data.is_sold_individually;
      meta_title.value = data.meta_title;
      meta_keywords.value = data.meta_keywords;
      meta_description.value = data.meta_description;
      stock_quantity.value = data.stock_quantity;
      is_featured.value = data.is_featured;
      is_new.value = data.is_new;
      feature_image.value = data.feature_image;
      attributes.value = data.attributes;
      weight.value = data.weight;
      dimensions.value = data.dimensions;
      additional_information.value = data.additional_information;
      is_in_stock.value = data.is_in_stock;
      sold_quantity.value = data.sold_quantity;
      additional_shipping_info.value = data.additional_shipping_info;
      shipping_rules.value = data.shipping_rules;
      tags.value = data.tags;
      warranty_period.value = data.warranty_period;
...
const submitForm = async () => {
  ...
  try {
    ...
    if (result.isConfirmed) {
      const { id } = route.params;
      const response = await auth.fetchProtectedApi(`/api/update-product/${id}`, payload, 'PUT');
      if (response.status) {
