  ...
  <header class="sticky top-0 z-50 flex items-center justify-between bg-white shadow  py-3 px-6">
    ...
    <div class="flex items-center space-x-4">
          ...
          <div class="p-2">
            <template v-for="notification in notifications" :key="notification.id">
              <a href="#" @click.prevent="markAsRead(notification.id)"
                :class="notification.read_at ? 'text-gray-500' : 'text-blue-700'" class="block py-1 text-sm">
      ...
      <div class="relative">
        ...
        <!-- Profile Dropdown -->
        <div v-if="isProfileDropdownOpen" class="absolute right-0 mt-2 w-64 bg-white shadow rounded-lg" ref="dropdownMenu">
          ...
          <ul class="pt-2">
            ...
            <li><a href="/org-dashboard/my-account/org-settings" class="block px-4 py-2 mb-3 text-gray-700 hover:bg-gray-100">Settings</a>
            </li>
