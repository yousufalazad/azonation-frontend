  ...
  <div class="container mx-auto max-w-7xl w-10/12 p-8 bg-white rounded-lg shadow-lg mt-12">
    ...
    <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
      <tbody class="text-gray-600 text-md font-medium">
        ...
        <tr>
          <td class="p-2 text-left font-semibold w-36"> Daily Total Member</td>
          <td class="p-2">:</td>
          <td class="p-2">{{ record.day_total_member }}</td>
        </tr>
        <tr>
          <td class="p-2 text-left font-semibold w-36">Daily Total Bill Amount</td>
          <td class="p-2">:</td>
          <td class="p-2">{{ record.day_total_bill }}</td>
        </tr>
        <tr>
