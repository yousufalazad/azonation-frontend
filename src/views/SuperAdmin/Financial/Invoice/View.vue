    ...
    <table class="w-full border-collapse border border-gray-300 text-sm text-left">
      <tbody>
        ...
        <tr>
          ...
          <td class="px-4 py-2 border border-gray-300">{{ invoiceDetails.item_name }}</td>
        </tr>
        <tr>
          <th class="px-4 py-2 border border-gray-300 w-36 bg-gray-100">Item Description</th>
          <td class="px-4 py-2 border border-gray-300">{{ invoiceDetails.item_description }}</td>
        </tr>

        <!-- Dates -->
        <tr>
          <th class="px-4 py-2 border border-gray-300 w-36 bg-gray-100">Generated At</th>
          <td class="px-4 py-2 border border-gray-300">{{ invoiceDetails.generated_at }}</td>
        </tr>
        <tr>
          <th class="px-4 py-2 border border-gray-300 w-36 bg-gray-100">Issued At</th>
          <td class="px-4 py-2 border border-gray-300">{{ invoiceDetails.issued_at }}</td>
        </tr>
        <tr>
          <th class="px-4 py-2 border border-gray-300 w-36 bg-gray-100">Due At</th>
          <td class="px-4 py-2 border border-gray-300">{{ invoiceDetails.due_at }}</td>
        </tr>
