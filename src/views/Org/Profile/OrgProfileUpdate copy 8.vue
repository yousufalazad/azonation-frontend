<template>
    <div class="profile-data-show">
        ...
        <div class="space-y-4">
         ...
         <!-- Modal -->
    <div v-if="modalVisibleAddress" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md mx-auto">
        ...
        <div class="mb-4">
          <label for="address_line_one" class="block text-sm font-medium text-gray-700">Address Line One</label>
          <input v-model="address_line_one" type="text" id="address_line_one"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
            required />
          <p v-if="auth.errors?.address_line_one" class="text-red-500 text-sm mt-1">{{ auth.errors?.address_line_one[0] }}</p>
        </div>

        <div class="mb-4">
          <label for="address_line_two" class="block text-sm font-medium text-gray-700">Address Line Two</label>
        ...
        <div class="mb-4">
          ...
          <input v-model="state_or_region" type="text" id="state_or_region"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
          <p v-if="auth.errors?.state_or_region" class="text-red-500 text-sm mt-1">{{ auth.errors?.state_or_region[0] }}</p>
        </div>
        ...
        <div class="mb-4">
          ...
          <p v-if="auth.errors?.postal_code" class="text-red-500 text-sm mt-1">{{ auth.errors?.postal_code[0] }}</p>
        </div>
        ...
        <div class="mb-4">
          ...
          <textarea v-model="country_id" id="country_id"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
          <p v-if="auth.errors?.country_id" class="text-red-500 text-sm mt-1">{{ auth.errors?.country_id[0] }}</p>
        </div>
