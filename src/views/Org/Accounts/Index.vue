        ...
        <div class="overflow-x-auto">
            <table class="min-w-full table-fixed border border-gray-200 text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-3 py-2 text-left font-medium text-gray-700 w-[1%]">#</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700 w-[10%]">Date</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700 w-[43%]">Title</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700 w-[21%]">Fund</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700 w-[7%]">Income</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700 w-[13%]">Expense</th>
                        <th class="px-3 py-2 text-left font-medium text-gray-700 w-[5%]">Action</th>
                    </tr>
                </thead>
                        ...
                        <td class="px-3 py-2">
                            <div class="flex gap-2">
                                <button @click="openModal(transaction)"
                                    class="px-2 py-1 bg-green-500 text-white text-xs rounded hover:bg-green-600">Edit</button>
                                <button @click="openViewModal(transaction)"
                                    class="px-2 py-1 text-xs text-white bg-gray-500 rounded hover:bg-gray-600">View</button>
                            </div>
                        </td>
                    </tr>
                </tbody>
