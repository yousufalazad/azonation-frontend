...
<template>
  <div class="p-6 bg-white rounded-lg shadow space-y-6">
    ...
    <div v-if="filteredTransactions.length > 0"
      class="text-green-700 bg-green-50 border border-green-300 rounded-md px-4 py-2 text-sm">
      ...
      <table class="min-w-full border border-gray-200 text-sm">
        ...
        <tbody class="bg-white divide-y divide-gray-100">
          <tr v-for="(transaction, index) in filteredTransactions" :key="transaction.id">
            ...
            <td v-if="visibleColumns.includes('title')" class="px-3 py-2">{{ transaction.transaction_title }}</td>
    ...
    <div v-if="viewModal"
      ...
      <div
        class="bg-white rounded-2xl shadow-xl p-6 w-full max-w-3xl relative overflow-y-auto max-h-[90vh]">
      ...
      <div
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
          ...
          <div>
            ...
            <input type="text" v-model="transaction_title"
              class="w-full border rounded px-3 py-1.5 text-sm" required />
          </div>
          <div>
