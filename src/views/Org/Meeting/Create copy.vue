...
const user_id = auth.user.id; // Assuming the org ID is stored in the logged-in user


const createMeeting = async () => {
  try {
    await auth.createMeeting(user_id, name.value, short_name.value, subject.value, date.value,
...
<template>
  ...
  <div class="card shadow-sm">
    <div class="card-body p-4">
      ...
      <div class="mb-3">
        <label for="short_name" class="form-label">Meeting short_name</label>
        <input v-model="short_name" type="text" id="short_name" class="form-control" placeholder="short_name">
        <p v-if="auth.errors?.short_name" class="text-danger mt-2">{{ auth.errors?.short_name[0] }}</p>
      </div>
      ...
      <div class="mb-3">
        ...
        <textarea v-model="description" type="text" id="description" rows="4"
      ...
      <div class="mb-3">
        ...
        <input v-model="status" type="dropdown" id="status" class="form-control" placeholder="Meeting status" required>
      ...
      <div class="mb-3">
        ...
        <input v-model="conduct_type" type="dropdown" id="conduct_type" class="form-control"
          placeholder="Meeting conduct type">
