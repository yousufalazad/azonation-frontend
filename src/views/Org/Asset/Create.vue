    ...
    <form @submit.prevent="submitForm" class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <select v-model="is_long_term" id="is_long_term" class="w-full border border-gray-300 rounded-md py-2 px-4">
        ...
        <div>
          ...
          <select v-model="is_tangible" id="is_tangible" class="w-full border border-gray-300 rounded-md py-2 px-4">
            <option :value="1">Yes</option>
            <option :value="0">No</option>
          </select>
        </div>
      ...
      <div>
        ...
        <div class="space-y-3">
          <div v-for="(file, index) in images" :key="file.id" class="flex flex-col sm:flex-row sm:items-center gap-4">
            <input type="file" class="w-full sm:w-auto border border-gray-300 rounded-md py-2 px-4" accept="image/*"
            ...
            <div v-if="file.file && file.file.preview" class="flex items-center gap-3">
              ...
              <button type="button" class="bg-red-500 text-white px-2 py-1 text-sm rounded hover:bg-red-600"
        ...
        <button type="button"
          class="mt-3 w-full sm:w-auto bg-blue-500 text-white py-1 px-3 rounded-md hover:bg-blue-700"
      ...
      <div>
        ...
        <div class="space-y-3">
          <div v-for="(file, index) in documents" :key="file.id"
            ...
            <!-- Preview + Remove SAME ROW -->
            <div v-if="file.file" class="flex items-center justify-between w-full sm:w-auto gap-3">
