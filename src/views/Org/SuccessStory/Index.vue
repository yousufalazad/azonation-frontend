...
const selectedProfile = ref(
  localStorage.getItem("success_story_profile") || "detailed",
);
  ...
  <div class="p-4 md:p-6 space-y-6 bg-white shadow rounded-lg">
    ...
    >
      ...
      <div class="flex flex-wrap gap-2">
        <button
          @click="exportCSV"
          class="flex items-center gap-1 border bg-white px-3 py-1.5 text-sm rounded hover:bg-gray-100"
        >
        ...
        <button
          @click="router.push({ name: 'create-success-story' })"
      ...
      >
        ...
        <template #item-actions="{ id }">
          <div class="flex justify-end flex-wrap gap-2">
            <button
              @click="
                router.push({ name: 'view-success-story', params: { id } })
              "
              class="bg-white text-gray-700 hover:bg-gray-100 border rounded-md py-1 px-3"
            >
              View
            </button>
            <button
              @click="
                router.push({ name: 'edit-success-story', params: { id } })
              "
              class="bg-white text-gray-700 hover:bg-gray-100 border rounded-md py-1 px-3"
            >
              Edit
