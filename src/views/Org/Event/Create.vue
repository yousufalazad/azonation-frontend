    ...
    <div class="max-w-3xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="mb-4">
                ...
                <div class="space-y-3">
                    <div v-for="(file, index) in documents" :key="file.id"
                        ...
                        <span v-if="file.file" class="w-full sm:w-32 truncate">
                            {{ file.file.name }}
                        </span>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-4">
                <button type="submit"
                    class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 w-full sm:w-auto">
                    Add Event
                </button>
                <button type="button" @click="resetForm"
                    class="px-6 py-2 bg-gray-400 text-white rounded-md hover:bg-gray-500 w-full sm:w-auto">
                    Reset
                </button>
            </div>
