...
const selectedProfile = ref(
  localStorage.getItem("strategic_profile") || "detailed",
);
const visibleColumns = ref(
  JSON.parse(localStorage.getItem("strategic_columns")) || [
    "title",
    "start_date",
    "end_date",
    "privacy",
...
const filteredRecords = computed(() => {
  return recordList.value.filter((r) => {
    ...
    const matchQuick =
      quickFilter.value === "" || r.status === quickFilter.value;
  ...
  <div class="p-6 space-y-6 bg-white shadow rounded-lg">
    ...
    >
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <button
          @click="$router.push({ name: 'create-strategic-plan' })"
      ...
      >
        ...
        <template #item-actions="{ id }">
          <div class="flex justify-end gap-2">
            <button
              @click="
                $router.push({ name: 'view-strategic-plan', params: { id } })
              "
            ...
            <button
              @click="
                $router.push({ name: 'edit-strategic-plan', params: { id } })
              "
              class="bg-white text-gray-700 hover:bg-gray-100 border border-gray-300 rounded-md py-1 px-3"
            >
              Edit
